...
const HomeCTA = () => {
  return (
    ...
    >
      <div className="absolute inset-0 bg-background/55 backdrop-blur-[1px]" aria-hidden="true" />
      <div className="absolute inset-0 bg-gradient-to-r from-background/70 via-background/35 to-transparent" aria-hidden="true" />
